...
import digit.academy.tutorial.api.DigitServiceCaller;
...
public class UserUtil {
    ...
    @Autowired
    private DigitServiceCaller serviceRequestRepository;
    ...
    @Autowired
    public UserUtil(ObjectMapper mapper, DigitServiceCaller serviceRequestRepository) {
        this.mapper = mapper;
    ...
    public void addUserDefaultFields(String mobileNumber,String tenantId, User userInfo, UserType userType){
        ...
        userInfo.setType(userType.name());
