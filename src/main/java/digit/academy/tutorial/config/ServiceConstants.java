...
public class ServiceConstants {
    ...
    public static final String REGISTRATION_SEQ_ID = "seq_adv_reg";
    public static final String REGISTRATION_SEQ_FORMAT = "[seq_adv_reg]_[cy:yyyy]";
    public static final String DUPLICATE_ERROR = "duplicateError";
    public static final String DUPLICATE_ERROR_MSG = "duplicate application request exists in the system";
}
